     ...
     for i in range(4):
          ...
          if near_success:
               ...
               if emiss_nz['Neutrality']=='Yes':
                    ...
                    emi_list = np.array(emi_calc(E0,g0,Elong,dg_near,dg_long,yr_last+1,yr_near,yr_near+1))
                    emiss_proj.iloc[i,0:9] = emi_list#+emi_list[yr_near-yr_last]*(2100-yr_near)
